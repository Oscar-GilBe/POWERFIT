...
<%
    ...
    String cliente = ((UsuarioVO) request.getSession().getAttribute("usuario")).getCorreo();
    String actividad = request.getParameter("actividad");
	if (actividad == null || actividad.isEmpty()) {
		request.getSession().setAttribute("error", "Selecciona una actividad para crear una reseña");
...
<head>
    ...
    <title>Crear reseña - PowerFit</title> <!-- Título de la página -->
...
<body>
    ...
    <div class="main-content"> <!-- Contenedor principal que engloba el contenido -->
        ...
        <div class="title-container">
            <h1 class="page-title">CREAR RESEÑA</h1>
            <p class="page-subtitle">Aquí podrás crear una reseña.</p>
        </div>
        ...
        <div class="review-container"> <!-- Contenedor de la reseña -->
		    ...
		    <form action="/POWERFIT/cliente/CrearReseña" method="post" class="review-form">
		        ...
		        <div>
		            <button type="button" class="delete-account-btn" onclick="window.location.href='/POWERFIT/cliente/InfoActividad?actividad=<%= actividad %>'">CANCELAR</button>
