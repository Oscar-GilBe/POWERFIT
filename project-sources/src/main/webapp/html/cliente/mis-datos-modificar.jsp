...
<body>
    ...
    <div class="sidebar" id="sidebar"> <!-- Contenedor del panel lateral -->
        ...
        <!-- Enlaces de navegación que se moverán al menú lateral en versión móvil -->
    ...
    <div class="main-content"> <!-- Contenedor principal que engloba el contenido -->
        ...
        <form action="/POWERFIT/cliente/ModificarDatos" method="post" class="login-reg-form">
        <% HttpSession session1 = request.getSession(false);
            ...
            <div> 
            	<button type="button" class="delete-account-btn" onclick="window.location.href='/POWERFIT/html/cliente/mis-datos-ver.jsp'">CANCELAR</button> <!-- Botón de cancelar -->
