        ...
        <section>
            ...
            <div class="actividad-detalle">
                ...
                <div class="actividad-info">
		            ...
		            <!-- Botones de acción (debajo de la información y centrados) -->
		            <div class="action-buttons">
		                <form action="/POWERFIT/cliente/ListarClasesActividad" method="post" style="display:inline;">
		                    ...
		                    <button type="submit" class="opinion-button">Ver clases</button>
		                </form>
		                <form action="/POWERFIT/cliente/ListarReseñasActividad" method="get" style="display:inline;">
		                    <input type="hidden" name="actividad" value="${actividad.nombre}">
		                ...
		                <form action="/POWERFIT/html/cliente/reseña-crear.jsp" method="get" style="display:inline;">
		                    <input type="hidden" name="actividad" value="${actividad.nombre}">
		                    <button type="submit" class="opinion-button">Crear reseña</button>
		                </form>
		            </div>
		        </div>   
                ...
                <div class="actividad-imagen">
                    <c:if test="${not empty imagenBase64}">
					    <img src="data:image/jpeg;base64,${imagenBase64}" alt="Imagen de ${actividad.nombre}" />
					</c:if>
                </div>
            </div>
