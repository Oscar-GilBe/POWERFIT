    ...
    <div class="main-content">
     <!-- Encabezado -->
        ...
        <section>
            ...
            <form action="/POWERFIT/administrador/CargarCrearActividad" method="get" style="display: inline;">
			    <button id="addActividadBtn" type="submit">Nueva Actividad</button> 
			</form>

			<form action="/POWERFIT/administrador/ListarActividades" method="get">
                    ...
                    <div class="actividad-list">
                        <c:forEach var="actividad" items="${entry.value}">
                            <div class="actividad-item">
                            	<form action="/POWERFIT/administrador/InfoActividad" method="get">
