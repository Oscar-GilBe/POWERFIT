                ...
                <div class="actividad-info">
	                ...
	                <div class="action-buttons">
                       <form action="/POWERFIT/administrador/EliminarActividad" method="post" style="display:inline;">
                        ...
                        <form action="/POWERFIT/administrador/InfoActividad" method="get" style="display:inline;">
                        	<input type="hidden" name="actividad" value="${actividad.nombre}">
	            ...
	            <section>
	                <%
	                	...
	                	if (listaResenas == null) {
	                		...
	                		request.getSession().setAttribute("error", "Selecciona una actividad");
	                        request.getRequestDispatcher("/administrador/ListarActividades");
	                        return;
	                	}
