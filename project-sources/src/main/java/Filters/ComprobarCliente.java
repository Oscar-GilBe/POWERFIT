...
public class ComprobarCliente implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (user == null) {
            ...
            // Si el usuario existe pero no es del tipo CLIENTE
            String errorMessage = "Debes ser Cliente para acceder a esta página.";
            session.setAttribute("error", errorMessage);
            ...
            // El usuario está autenticado y es Cliente, permitimos el acceso
