...
public class ComprobarAdministrador implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (user == null) {
            ...
            // Si el usuario existe pero no es del tipo ADMINISTRADOR
            String errorMessage = "Debes ser Administrador para acceder a esta página.";
            session.setAttribute("error", errorMessage);
            ...
            // El usuario está autenticado y es Administrador, permitimos el acceso
