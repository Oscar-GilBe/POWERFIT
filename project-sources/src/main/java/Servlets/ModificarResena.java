...
@WebServlet("/cliente/ModificarResena")
public class ModificarResena extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            request.getRequestDispatcher("/html/cliente/reseñas.jsp").forward(request, response);
            return;
