...
@WebServlet("/cliente/InfoActividad")
public class InfoActividadCliente extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */
    public InfoActividadCliente() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println("Servlet /cliente/InfoActividad");
		...
		if (nombre_actividad == null || nombre_actividad.isEmpty()) {
            ...
            request.getRequestDispatcher("/html/cliente/info-actividad.jsp").forward(request, response);
		}
	}
