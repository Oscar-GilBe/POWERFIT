...
@WebServlet("/cliente/ListarActividades")
public class ListarActividadesCliente extends HttpServlet {
    private static final long serialVersionUID = 1L;

    /**
     * @see HttpServlet#HttpServlet()
     */   
    public ListarActividadesCliente() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            switch (ordenarPor) {
                ...
                case "dificultad":
                    // Crear un LinkedHashMap para mantener el orden "fácil", "media", "difícil"
        ...
        request.getRequestDispatcher("/html/cliente/listar-actividades.jsp").forward(request, response);
    }
