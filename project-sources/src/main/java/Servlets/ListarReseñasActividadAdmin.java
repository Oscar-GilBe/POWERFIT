...
@WebServlet("/administrador/ListarReseñasActividad")
public class ListarReseñasActividadAdmin extends HttpServlet {
    private static final long serialVersionUID = 1L;
    
    /**
     * @see HttpServlet#HttpServlet()
     */ 
    public ListarReseñasActividadAdmin() {
        super();
    }
    /**
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (nombre_actividad == null || nombre_actividad.isEmpty()) {
	        ...
	        request.getRequestDispatcher("/html/administrador/info-actividad-reseñas.jsp").forward(request, response);
		}
    }
