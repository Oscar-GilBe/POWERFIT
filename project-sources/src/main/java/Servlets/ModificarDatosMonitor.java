...
@WebServlet("/monitor/ModificarDatos")
public class ModificarDatosMonitor extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ModificarDatosMonitor() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (email == null || email.isEmpty()) {
			...
			request.getRequestDispatcher("/html/monitor/mis-datos-modificar.jsp").forward(request, response);
			return;
		} 
        ...
        UsuarioVO usuario = new UsuarioVO(email, nombre, apellidos, PasswordUtil.hashPassword(contrasena), TipoUsuario.MONITOR);
        try {
        ...
        request.getRequestDispatcher("/html/monitor/datos-modificados.html").forward(request, response);      
	}
