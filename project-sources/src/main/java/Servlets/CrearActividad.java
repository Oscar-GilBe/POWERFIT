...
@MultipartConfig
@WebServlet("/administrador/CrearActividad")
public class CrearActividad extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        LocalDate fechaLimite = currentYearMonth.atEndOfMonth(); // Último día del mes actual
        ...
        String imageName = nombre + "." + getFileExtension(filePart); // Genera el nombre de la imagen
        ...
        try {
            ...
            // Fecha actual para iniciar la creación de las clases
            ...
            if (!todoOK) {
                ...
                request.getRequestDispatcher("/html/administrador/crear-actividad.jsp"/* Pagina de error */).forward(request, response);
                return;
            }

            System.out.println("Clases creadas ");
            // Crear la actividad
            byte[] imageBytes = getFileBytes(imageFile);
            ...
            actividadDAO.insertActividadYClases(nuevaActividad, clases);
